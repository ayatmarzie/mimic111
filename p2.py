...
class MimicParser(object):
    ...
    def add_icd_infect(self, file_name):
        ...
        df_icd_ckd = df_icd[df_icd['ICD9_CODE'] == 9604]
...
if __name__ == '__main__':
    ...
    mp.add_notes(ROOT + FOLDER + FILE_STR + '_24_hour_blocks_plus_admissions_plus_patients_plus_scripts_plus_icds_9604.csv')